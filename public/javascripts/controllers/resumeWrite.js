...
function resumeWrite() {
    ...
    patient.assessments[0].clinicalHistoryPoints = clinicalHistoryPoints;
    ...
    patient.assessments[0].questionsOneToThreePoints = oneToThreeQuestionsPoints;
    ...
    patient.assessments[0].questionFourPoints = fourQuestionPoints;
    ...
    patient.assessments[0].questionsOneToFourPoints = oneToFourQuestionsPoints;
    ...
    patient.assessments[0].partTwoQuestionPoints = partTwoQuestionPoints;
    ...
    patient.assessments[0].clinicalAssessmentPoints = clinicalAssessmentPoints;
    ...
    patient.assessments[0].historyAssessmentPoints = historyAssessmentPoints;
